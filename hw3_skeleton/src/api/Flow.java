...
public class Flow {
	 ...
	 *
	 * @param endpoint0 a Cell
	 * @param endpoint1 a Cell
	 */
	 ...
	 *
	 * @return list of cells in this flow
	 */
	 ...
	 *
	 * @param i index (0 or 1) of the endpoint to return
	 * @return an endpoint associated with this flow
	 */
	 ...
	 *
	 * @return color of the cells associated with this flow
	 */
	...
	public boolean isComplete() {
		//iterates through
		if (cells.size() >= 2) {
			//gets the first cell in the flow and the last and check to see if they are the endpoints, if they are the flow is complete
	...
	/**
	 * Turns the endpoitns into a string
	 *
	 * @return the endpoint in the form a string
	 */
	@Override
