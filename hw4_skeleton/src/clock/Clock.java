...
public class Clock implements Runnable {
     ...
     *
     * @param fFps A float representing the desired Frames per second.
     * @param u    The interface object that'll receive updates.
     */
     ...
     *
     * @param u The new interface to receive updates
     */
