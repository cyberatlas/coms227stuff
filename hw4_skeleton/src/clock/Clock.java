...
/**
 * The Clock class simply takes an Updatable, and calls update preiodically
 * according to a given FPS value.
 * <p>
...
public class Clock implements Runnable {
	...
	/*
	 * Overrides the Threads run method to update the Clock, and for greatest
	 * accuracy the iInterface.
	 */
	public void run() {
		do {
			bIsRunning = true;
