...
public class Cell implements Updatable {
     ...
     * coordinates).
     *
     * @param color   A background color for rendering
     * @param polygon A polygon for rendering
     */
     ...
     *
     * @param neighbors Adjacent cells
     */
     ...
     *
     * @param distance mouse distance for this cell
     */
     ...
     *
     * @param nextCell the cell to move the state to.
     */
