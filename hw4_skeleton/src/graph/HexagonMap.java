...
/**
 * A hexagonal lattice where each cell has 6 neighbors set up in a honeycone
 * pattern.
 *
...
public class HexagonMap extends GraphMap {
	...
	public Polygon createPolygon(int x, int y) {
		...
		int[] yCoor = { yOffset1, yOffset0, yOffset0, yOffset1, yOffset2, yOffset2 };
		int[] xCoor = { (int) xOffset0, (int) xOffset1, (int) xOffset2, (int) xOffset3, (int) xOffset2,
				(int) xOffset1 };
