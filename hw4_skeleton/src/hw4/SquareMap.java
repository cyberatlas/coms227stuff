...
/**
 * Creates a playing map using squares.
 * Subclass of GraphMap
 *
 * @author Alex
 */
public class SquareMap extends GraphMap {
    ...
    public int getPixelWidth() {
        //multiplies the number of columns by pixel length plus 1 pixel to account for the border
     ...
     */
    @Override
    //multiplies the nubmer of rows by the pixel length +1 pixel to account for the border
     ...
     * @return array of the cells above, below, to the left of, and to the right of the cell in the given position
     */
    @Override
     ...
     * @param col The column index of a Cell
     * @param row The row index of a Cell
     * @return a new Polygon with the arguments of the x and y vertecies and the number of verticies
     */
    @Override
    public Polygon createPolygon(int col, int row) {
        ...
        //we return a new Polygon based on the arrays of coordinates generated, there are 4 endpoints because a square only has 4 vertecies
