...
public class DungeonessCrab extends Food {
    /**
     * It reads in the method that food uses for handle and adds movement
     * If the food counter is 0 then it moves to an open cell
     *
     * @param cell the cell that this object belongs to
     */
    @Override
